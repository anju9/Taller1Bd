...
Feature: Formulario Popup Validation 
  ...
  Scenario: Diligenciamiento exitoso del formulario Popup Validation,
    ...
    Given  Autentico en colorlib con usuario "demo" y clave "demo"   
     ...
     | Valor1  |Golf  |Tennis    |Golf      |http://valor1.com  |valor@1gmail.com|valor1   |valor1   |123456 |123456 |-99.99|200.200.5.4|2018-01-22|2012/09/12 |
     Then  Verifico ingreso exitoso
     
  @CasoAlterno 
  Scenario: Dilingenciamiento con errores del formulario Popup Validation.
             Se presenta Globo Informativo indicando error en el diligenciamento de alguno de los campos.
             
    Given Autentico en colorlib con usuario "demo" y clave "demo"
    And   Ingreso a la funcionalidad Forms Validation
    When  Diligencio Formulario Popup Validation
     | Required|Select|Multiples1|Multiples2|Url                |Email           |Password1|Password2|MinSize|MaxSize|Number|IP         |Date      |DateEarlier|
     ||Golf  |Tennis    |Golf      |http://valor1.com  |valor@1gmail.com|valor1   |valor1   |123456 |123456 |-99.99|200.200.5.4|2018-01-22|2012/09/12 |
     |Valor1   |Choose a sport   |Tennis    |Golf      |http://valor1.com  |valor@1gmail.com|valor1   |valor1   |123456 |123456 |-99.99|200.200.5.4|2018-01-22|2012/09/12 |
